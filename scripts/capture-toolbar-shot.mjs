...
await page.goto('https://www.twitch.tv/ohnePixel', { waitUntil: 'domcontentloaded', timeout: 60000 });
...
if (box) {
  await page.screenshot({
    ...
    type: 'jpeg',
    quality: 90,
    clip: { x: Math.max(0, box.x - 20), y: Math.max(0, box.y - 15), width: box.width + 140, height: box.height + 30 },
  });
}
await ctx.close();
console.log('done');
